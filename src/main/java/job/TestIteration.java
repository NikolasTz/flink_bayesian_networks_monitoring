...
import static job.JobIteration.feedbackSource;
...
public class TestIteration {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<Input> inputStream = env
                                                        .readTextFile("datasets\\data_earthquake_1000")
                                                        ...
                                                        .map(new Mapper.MapperInput(config.workers()))
                                                        .name("Input Source");
