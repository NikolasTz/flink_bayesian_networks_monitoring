...
public class KafkaProducerArgs {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Kafka brokers TUC
        props.put("bootstrap.servers", "clu02.softnet.tuc.gr:6667,clu03.softnet.tuc.gr:6667,clu06.softnet.tuc.gr:6667");
        ...
        while (line != null && !line.equals("EOF")) {
            ...
            // int key = new Random().nextInt(Integer.parseInt(args[4]));
