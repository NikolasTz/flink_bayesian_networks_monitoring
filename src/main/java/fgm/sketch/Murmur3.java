...
// https://github.com/prasanthj/count-min-sketch/blob/bf02e4ad2639e96a1550b96dbb2a75490f4469aa/src/main/java/com/github/prasanthj/cmsketch/Murmur3.java#L23
...
public class Murmur3 {
     ...
     * @return - hashcode
     */
    public static int hash32(byte[] data) { return hash32(data, data.length, DEFAULT_SEED); }
     ...
     * @return - hashcode
     */
    public static long hash64(byte[] data) { return hash64(data, data.length, DEFAULT_SEED); }
     ...
     */
    public static long[] hash128(byte[] data) { return hash128(data, data.length, DEFAULT_SEED); }
